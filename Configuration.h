...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.04   // Z offset: -below +above  [the nozzle]
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 220 //X_BED_SIZE 220
#define Y_MAX_POS 220 //Y_BED_SIZE 220
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach).
   #define LEFT_PROBE_BED_POSITION +30 //MIN_PROBE_EDGE 20 0 + (+30) = +30
   #define RIGHT_PROBE_BED_POSITION 190//(X_BED_SIZE - MIN_PROBE_EDGE)220 +30 = 250
   #define FRONT_PROBE_BED_POSITION -25 //MIN_PROBE_EDGE 20 0 + (-25) = -25
   #define BACK_PROBE_BED_POSITION 245 //(Y_BED_SIZE - MIN_PROBE_EDGE) 220 + -25 = 195 
